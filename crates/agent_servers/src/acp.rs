...
/// Build a `Client` connection over `transport` with LEAD's full
...
impl AcpConnection {
    ...
    pub async fn stdio(
        ...
        let connection_future =
            connect_client_future("LEAD", transport, dispatch_tx.clone(), connection_tx);
        ...
        let initialize_response = into_foreground_future(
            connection.send_request(
                acp::InitializeRequest::new(acp::ProtocolVersion::V1)
                    ...
                    .client_info(
                        acp::Implementation::new("LEAD", version)
