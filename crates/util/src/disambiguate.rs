...
mod tests {
    ...
    fn test_duplicate_paths_from_multiple_groups() {
        ...
        // Simulates the sidebar scenario: a path like /Users/rtfeldman/code/LEAD
        // appears in two project groups (e.g. "LEAD" alone and "LEAD, roc").
        // After deduplication, only unique paths should be disambiguated.
        //
        // Paths:
        //   /Users/rtfeldman/code/worktrees/LEAD/focal-arrow/LEAD  (group 1)
        //   /Users/rtfeldman/code/LEAD                             (group 2)
        //   /Users/rtfeldman/code/LEAD                             (group 3, same path as group 2)
        //   /Users/rtfeldman/code/roc                             (group 3)
        //
        // A naive flat_map collects duplicates. The duplicate /code/LEAD entries
        ...
        let all_paths: Vec<&Path> = vec![
            Path::new("/Users/rtfeldman/code/worktrees/LEAD/focal-arrow/LEAD"),
            Path::new("/Users/rtfeldman/code/LEAD"),
        ...
        // focal-arrow/LEAD and code/LEAD both end in "LEAD", so they need detail 1.
        // "roc" is unique at detail 0.
        assert_eq!(details, vec![1, 1, 0]);

        assert_eq!(path_suffix(all_paths[0], details[0]), "focal-arrow/LEAD");
        assert_eq!(path_suffix(all_paths[1], details[1]), "code/LEAD");
