...
//! The main point of interest in this crate is [`Editor`] type, which is used in every other LEAD part as a user input element.
...
/// LEAD's primary implementation of text input, allowing users to edit a [`MultiBuffer`].
///
...
impl Editor {
    ...
    pub fn new_file(
        ...
        Self::new_in_workspace(workspace, window, cx).detach_and_prompt_err(
            ...
            |e, _, _| match e.error_code() {
                ...
                "The remote instance of LEAD does not support this yet. It must be upgraded to {}",
    ...
    fn trigger_on_type_formatting(
        ...
        // OnTypeFormatting returns a list of edits, no need to pass them between LEAD instances,
