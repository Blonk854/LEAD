...
mod git_worktrees {
    ...
    fn test_validate_worktree_directory() {
        ...
        // Valid: subdirectory
        assert!(
            worktrees_directory_for_repo(work_dir, ".git/LEAD-worktrees", PathStyle::Posix).is_ok()
        );
...
mod resolve_worktree_tests {
    ...
    fn test_repo_identity_path() {
        let examples = [
            ...
            ("/home/bob/LEAD/.git", "/home/bob/LEAD"),
    ...
    fn test_linked_worktree_short_name() {
        let examples = [
            (
                "/home/bob/LEAD",
                "/home/bob/worktrees/olivetti/LEAD",
                Some("olivetti".into()),
            ),
            ("/home/bob/LEAD", "/home/bob/zed2", Some("zed2".into())),
            (
                "/home/bob/LEAD",
                "/home/bob/worktrees/LEAD/selectric",
                Some("selectric".into()),
            ),
            ("/home/bob/LEAD", "/home/bob/LEAD", None),
        ];
