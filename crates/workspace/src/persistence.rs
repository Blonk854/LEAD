    ...
    const MIGRATIONS: &[&str] = &[
        sql!(
            CREATE TABLE workspaces(
                ...
                dock_visible INTEGER, // Deprecated. Preserving so users can downgrade LEAD.
                dock_anchor TEXT, // Deprecated. Preserving so users can downgrade LEAD.
                dock_pane INTEGER, // Deprecated.  Preserving so users can downgrade LEAD.
        ...
        // Preserving so users can downgrade LEAD.
        sql!(
...
impl WorkspaceDb {
    ...
    // session was closed (i.e. when LEAD was quit).
