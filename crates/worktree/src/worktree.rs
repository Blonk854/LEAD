...
///
/// Has an absolute path, and may be set to be visible in LEAD UI or not.
...
/// * a directory opened in LEAD — may be added as a visible entry to the current worktree
///
...
impl BackgroundScanner {
    ...
    async fn process_events(&self, mut events: Vec<PathEvent>) {
        ...
        //
        // Certain directories may have FS changes, but do not lead to git data changes that LEAD cares about.
        // Ignore these, to avoid LEAD unnecessarily rescanning git metadata.
