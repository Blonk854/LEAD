...
#[derive(Error, Debug)]
#[error(
    "You must update to LEAD version {minimum_version} or higher to continue using edit predictions."
)]
...
fn is_upsell_dismissed(cx: &App) -> bool {
    // To make this backwards compatible with older versions of LEAD, we
