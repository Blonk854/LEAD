...
//! It uses LEAD's terminal emulator to process and display text, supporting ANSI escape
...
/// * error tracebacks
///
/// It uses LEAD's terminal emulator backend to process and render text,
