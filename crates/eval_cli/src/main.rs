//! Headless CLI binary for running LEAD's agent in evaluation/benchmark environments.
//!
...
#[command(
    name = "eval-cli",
    about = "Run LEAD's agent headlessly in evaluation/benchmark environments"
)]
struct Args {
    /// Output current environment variables as JSON to stdout.
    /// Used internally by LEAD's shell environment capture.
    #[arg(long, hide = true)]
    printenv: bool,
