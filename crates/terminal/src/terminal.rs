...
/// Inserts LEAD-specific environment variables for terminal sessions.
...
pub fn insert_zed_terminal_env(
    ...
    env.insert("TERM_PROGRAM".to_string(), "LEAD".to_string());
...
impl Terminal {
    ...
    /// remote host, in case LEAD is connected to a remote host.
    ...
    fn register_task_finished(
        ...
        if !lines_to_show.is_empty() {
            ...
            // when LEAD task finishes and no more output is made.
