...
/// Fetches LEAD-relevant Pseudo-Terminal (PTY) process information
...
impl PtyProcessInfo {
    ...
    /// Updates the cached process info, emitting a [`Event::TitleChanged`] event if the LEAD-relevant info has changed
