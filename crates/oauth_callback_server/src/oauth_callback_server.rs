...
//!
//! Used by LEAD's OAuth-based sign-in flows (e.g. MCP servers, ChatGPT
...
/// layout styled to match LEAD's dark theme. The `title` is rendered as a
                ...
                let (status_code, body) = match &result {
                    Ok(_) => (
                        ...
                        oauth_callback_page(
                            ...
                            "You can close this tab and return to LEAD.",
                            false,
                        ),
                    ),
                    Err(err) => {
                        ...
                        (
                            ...
                            oauth_callback_page(
                                ...
                                "Something went wrong. Please try again from LEAD.",
                                true,
                            ),
                        )
                    }
