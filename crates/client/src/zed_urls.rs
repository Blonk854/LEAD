//! Contains helper functions for constructing URLs to various LEAD-related pages.
//!
...
/// Returns the URL to LEAD's terms of service.
pub fn terms_of_service(cx: &App) -> String {
    format!("{server_url}/terms-of-service", server_url = server_url(cx))
}

/// Returns the URL to LEAD AI's privacy and security docs.
...
/// Returns the URL to LEAD's edit prediction documentation.
...
/// Returns the URL to LEAD's ACP registry blog post.
