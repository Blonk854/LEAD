                            ...
                            for part in &tool_result.content {
                                match part {
                                    ...
                                    LanguageModelToolResultContent::Image(_) => {
                                        text_parts.push("[Tool responded with an image, but LEAD doesn't support these in Mistral models yet]".to_string());
                                    }
                                }
                            }
    ...
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        if self.load_credentials_task.is_some() {
            ...
            v_flex()
                ...
                .child(Label::new("To use LEAD's agent with Mistral, you need to add an API key. Follow these steps:"))
                .child(
                    List::new()
                        .child(
                            ListBulletItem::new("")
                ...
                .child(
                    Label::new(
                        format!("You can also set the {API_KEY_ENV_VAR_NAME} environment variable and restart LEAD."),
                    )
        ...
        let request = LanguageModelRequest {
            messages: vec![LanguageModelRequestMessage {
                ...
                content: vec![
                    ...
                    MessageContent::Image(LanguageModelImage::from_source("base64data")),
                ],
                cache: false,
                reasoning_details: None,
            }],
