...
impl HttpClientWithUrl {
    ...
    /// Builds a LEAD API URL using the given path.
    ...
    /// Builds a LEAD Cloud URL using the given path.
    ...
    /// Builds a LEAD Cloud URL using the given path and query params.
    ...
    /// Builds a LEAD LLM URL using the given path.
