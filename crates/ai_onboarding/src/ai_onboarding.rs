...
impl ZedAiOnboarding {
    ...
    fn render_sign_in_disclaimer(&self, _cx: &mut App) -> AnyElement {
        ...
        v_flex()
            ...
            .relative()
            .gap_1()
            .child(Headline::new("Welcome to LEAD AI"))
            .child(
                Label::new("Sign in to try LEAD Pro free for 14 days.")
                    .color(Color::Muted)
                    .mb_2(),
            )
            .child(PlanDefinitions.sign_in_upsell())
            .child(
                Button::new("sign_in", "Try LEAD Pro for Free")
                    .disabled(signing_in)
                    .full_width()
    ...
    fn render_trial_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to the LEAD Pro Trial"))
            .child(
    ...
    fn render_pro_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to LEAD Pro"))
            .child(
    ...
    fn render_business_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to LEAD Business"))
            .child(
                Label::new("Here's what you get:")
                    .color(Color::Muted)
                    .mb_2(),
    ...
    fn render_student_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to LEAD Student"))
            .child(
                Label::new("Here's what you get:")
                    .color(Color::Muted)
                    .mb_2(),
...
impl Component for ZedAiOnboarding {
    ...
    fn description() -> &'static str {
        ...
        guiding them through signing in to LEAD and selecting a plan \
