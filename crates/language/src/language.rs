//! The `language` crate provides a large chunk of LEAD's language-related
...
pub trait LspAdapter: 'static + Send + Sync + DynLspInstaller {
    ...
    /// provide autocompletion and diagnostics in LEAD setting and keybind
    /// files
    ...
    /// for settings that should be persisted to LEAD's settings file.
    ...
    LI: LspInstaller<BinaryVersion = BinaryVersion> + LspAdapter,
{
    ...
    fn get_language_server_command(
        ...
        async move {
            ...
            //      worktree 3: no gopls found in PATH -> fallback to LEAD installation
            //
...
impl LanguageScope {
    ...
    ///
    /// By default, LEAD treats as paragraph and comment prefixes as boundaries.
    ...
    ///
    /// By default, LEAD treats alphanumeric characters (and '_') as word characters for
