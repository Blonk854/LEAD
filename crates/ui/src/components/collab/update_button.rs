...
impl UpdateButton {
    ...
    pub fn checking() -> Self {
        Self::new(IconName::LoadCircle, "Checking for LEAD Updates…")
            .icon_animate(true)
            .disabled(true)
    }

    pub fn downloading(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::Download, "Downloading LEAD Update…")
            .tooltip(version)
            .disabled(true)
    }

    pub fn installing(version: impl Into<SharedString>) -> Self {
        Self::new(IconName::LoadCircle, "Installing LEAD Update…")
            .icon_animate(true)
            .tooltip(version)
            .disabled(true)
    }
...
impl Component for UpdateButton {
    ...
    fn description() -> &'static str {
        ...
        show auto-update status and allow users to restart LEAD."
    }
