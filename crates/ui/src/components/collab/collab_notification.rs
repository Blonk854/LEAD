            ...
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new("LEAD").color(Color::Muted)),
                    )
                    .into_any_element(),
            ),
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new(
                            "a_very_long_username_that_might_overflow is sharing a project in LEAD:",
                        ))
                        .child(
                            Label::new("zed-cloud, LEAD, edit-prediction-bench, zed.dev")
                                .color(Color::Muted),
                        ),
                    )
                    .into_any_element(),
            ...
            single_example(
                ...
                container()
                    .child(
                        ...
                        .child(Label::new(
                            "maxbrunsfeld invited you to join the #LEAD channel",
                        )),
                    )
                    .into_any_element(),
            ),
