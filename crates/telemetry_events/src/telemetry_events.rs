//! See [Telemetry in LEAD](https://zed.dev/docs/telemetry) for additional information.
...
pub struct EventRequestBody {
    /// Identifier unique to each system LEAD is installed on
    pub system_id: Option<String>,
    /// Identifier unique to each LEAD installation (differs for stable, preview, dev)
    pub installation_id: Option<String>,
    /// Identifier unique to each logged in LEAD user (randomly generated on first sign in)
    /// Identifier unique to each LEAD session (differs for each time you open LEAD)
    pub session_id: Option<String>,
    pub metrics_id: Option<String>,
    /// True for LEAD staff, otherwise false
    ...
    /// LEAD release channel (stable, preview, dev)
