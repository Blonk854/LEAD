...
pub struct ProjectSettingsContent {
    ...
    /// Whether to disable all AI features in LEAD.
    ///
    /// Default: false
...
pub struct LspSettings {
    ...
    /// this setting can be used to enable or disable them in LEAD.
    /// Default: true
...
pub struct GitSettings {
    ...
    /// `"../worktrees"` and a project at `~/code/LEAD`, worktrees are
    /// created under `~/code/worktrees/LEAD/`.
    ///
    ...
    /// - `".git/LEAD-worktrees"` — `<project>/.git/LEAD-worktrees/`
