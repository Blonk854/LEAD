...
pub struct SettingsContent {
    ...
    /// Configuration of audio in LEAD.
    ...
    /// This base keymap settings adjusts the default keybindings in LEAD to be similar
    /// to other common code editors. By default, LEAD's keymap closely follows VSCode's
    ...
    // Settings related to calls in LEAD
    pub calls: Option<CallSettingsContent>,

    /// Settings for the which-key popup.
    pub which_key: Option<WhichKeySettingsContent>,

    /// Settings related to Vim mode in LEAD.
...
pub enum ProfileBase {
    ...
    #[default]
    User,
    /// Apply profile settings on top of LEAD's default settings, ignoring user customizations.
    Default,
}
...
pub struct SettingsProfile {
    ...
    /// - `default`: Apply on top of LEAD's default settings, ignoring user customizations
    #[serde(default)]
...
pub struct AudioSettingsContent {
    ...
    /// Microphones are too quite in LEAD, until everyone is on experimental
...
pub struct TelemetrySettingsContent {
    ...
    /// Send anonymized usage data like what languages you're using LEAD with.
    ///
    /// Default: true
...
pub struct DebuggerSettingsContent {
    ...
    /// Whether the breakpoints should be reused across LEAD sessions.
    ///
    /// Default: true
    ...
    /// Whether to log messages between active debug adapters and LEAD
    ///
    /// Default: true
...
/// Configuration of voice calls in LEAD.
#[with_fallible_options]
#[derive(Clone, PartialEq, Default, Serialize, Deserialize, JsonSchema, MergeFrom, Debug)]
...
pub struct FileFinderSettingsContent {
    ...
    /// Only the file LEAD had indexed will be used, not necessary all the gitignored files.
    ///
    /// Default: Smart
...
pub enum IncludeIgnoredContent {
    ...
    All,
    /// Use only the files LEAD had indexed
    Indexed,
...
pub struct SshConnection {
    ...
    // By default LEAD will download the binary to the host directly.
    // If this is set to true, LEAD will download the binary to your local machine,
