...
impl EditPredictionProvider {
    ...
    pub fn display_name(&self) -> Option<&'static str> {
        match self {
            EditPredictionProvider::Zed => Some("LEAD AI"),
...
pub struct EditPredictionSettingsContent {
    ...
    /// Controls whether LEAD may collect training data when using LEAD's Edit Predictions.
...
/// Controls whether LEAD collects training data when using LEAD's Edit Predictions.
#[derive(
    Copy,
    Clone,
    Debug,
...
pub enum EditPredictionDataCollectionChoice {
    ...
    #[default]
    Default,
    /// Allow LEAD to collect training data from open-source projects.
    Yes,
...
pub struct LanguageSettingsContent {
    ...
    /// LEAD's Prettier integration settings.
    ...
    /// when you type '(', LEAD will automatically add a closing ')' at the correct position.
    ///
    /// Default: true
    pub use_autoclose: Option<bool>,
    /// Whether to automatically surround text with characters for you. For example,
    /// when you select text and type '(', LEAD will automatically surround text with ().
    ///
    /// Default: true
...
#[serde(rename_all = "snake_case")]
pub enum Formatter {
    /// Format files using LEAD's Prettier integration (if applicable),
    /// or falling back to formatting via language server.
    #[default]
    Auto,
    /// Do not format code.
    None,
    /// Format code using LEAD's Prettier integration.
    Prettier,
...
pub struct LanguageTaskSettingsContent {
    ...
    pub enabled: Option<bool>,
    /// Use LSP tasks over LEAD language extension ones.
    /// If no LSP tasks are returned due to error/timeout or regular execution,
    /// LEAD language extension tasks will be used instead.
    ///
    /// Other LEAD tasks will still be shown:
    /// * LEAD task from either of the task config file
    /// * LEAD task from history (e.g. one-off task was spawned before)
