...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "LEAD Editor Dev Instance Running",
        ReleaseChannel::Nightly => "LEAD Editor Nightly Instance Running",
        ReleaseChannel::Preview => "LEAD Editor Preview Instance Running",
        ReleaseChannel::Stable => "LEAD Editor Stable Instance Running",
    }
}
